...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=LENOVO-NA-ALEKS\SQLEXPRESS;Database=TravelAgency;Integrated Security=true;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.TourPackageId, e.GuideId });
            });
